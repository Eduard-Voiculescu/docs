...
- `specVersion`: a Semver version indicating which version of this API is being used. See [versions](#versions) section to see more details on features & releases.
...
The `specVersion` in the subgraph manifest specifies the semver version indicating which version of this API is being used in the subgraph.
